---
author: "Jim Bennett"
categories: ["technology", "AI", "IoT", "adafruit", "tinyml", "edge"]
date: 2020-04-21T18:00:00Z
description: ""
draft: false
images:
  - /blogs/recognizing-words-on-a-microcontroller-using-tinyml/banner.jpg
featured_image: banner.jpg
slug: "recognizing-words-on-a-microcontroller-using-tinyml"
summary: "Learn how to train a TinyML word recognizer to run on a microcontroller using Azure ML Studio and the Adafruit EdgeBadge."
...
I trained my new model using the [Azure Machine Learning Studio](https://azure.microsoft.com/services/machine-learning/#product-overview/?WT.mc_id=aiapril-blog-jabenn), a service that allows you to build and train models using cloud compute, then either host them in the cloud or download them for use offline.

### Create an Azure account

To use Azure services you will need an Azure subscription. If you don't have a subscription you can sign up for free.

* If you are a student aged 18 and up and have an email address from an academic institution, you can sign up for the free Azure for Students offer at [azure.microsoft.com/free/students](https://azure.microsoft.com/free/students/?WT.mc_id=aiapril-blog-jabenn) without a credit card. At the time of writing this gives you $100 of credit to use over 12 months, as well as free tiers of a number of services for that 2 months. At the end of the 12 months, if you are still a student you can renew and get another $100 in credit and 12 months of free services.

* If you are not a student, you can sign up at [azure.microsoft.com/free](https://azure.microsoft.com/free/?WT.mc_id=aiapril-blog-jabenn). You will need a credit card for verification purposes only, you will not be billed unless you decide to upgrade your account to a paid offering. At the time of writing the free account will give you US$200 of free credit to spend on what you like in the first 30 days, 12 months of free services, plus a load of services that have tiers that are always free.
...
1. Open the [Azure portal](https://portal.azure.com/?WT.mc_id=aiapril-blog-jabenn)

1. Select **Create a resource** then search for `Machine Learning`. Select **Machine Learning** then select **Create**.

    ![The Machine Learning resource](https://raw.githubusercontent.com/jimbobbennett/EdgeBadge-WordRecogniser/master/images/CreateMLResource.png)
...
1. Open ML Studio at [ml.azure.com](https://ml.azure.com/?WT.mc_id=aiapril-blog-jabenn)
...
> You can see the pricing per hour on the [Machine Learning pricing page](https://azure.microsoft.com/pricing/details/machine-learning/?WT.mc_id=aiapril-blog-jabenn)
...
1. Install [Visual Studio Code](https://code.visualstudio.com/Download/?WT.mc_id=aiapril-blog-jabenn)
...
The code for the edge badge is in the `word_recognizer` folder in [this GitHub repo](https://github.com/jimbobbennett/EdgeBadge-WordRecogniser). Clone the repo and open the `word_recognizer` folder in Visual Studio Code.
...
1. Double tap the **Reset** button on the back of the EdgeBadge to put it into the boot loader ready to program
    ...
    ![EdgeBadge in bootloader mode](https://raw.githubusercontent.com/jimbobbennett/EdgeBadge-WordRecogniser/master/images/BootLoader.png)
